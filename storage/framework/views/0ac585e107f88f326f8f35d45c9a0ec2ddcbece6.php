...
<?php $__env->startSection('content'); ?>
    <div class="permissions">
        ...
        <div class="mt-8 bg-white rounded">
            <form action="<?php echo e(route('permission.store')); ?>" method="POST" class="w-full max-w-lg px-6 py-12">
                <?php echo csrf_field(); ?>
        ...
        <div class="mt-8 bg-white rounded border-b-4 border-gray-300">
            ...
            <?php $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex flex-wrap items-center text-gray-700 border-t-2 border-l-4 border-r-4 border-gray-300">
                    <div class="w-8/12 px-4 py-3 text-sm font-semibold text-gray-600 tracking-tight"><?php echo e($permission->name); ?></div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Fifa\laravel-school-management-system\resources\views/backend/permissions/create.blade.php ENDPATH**/ ?>