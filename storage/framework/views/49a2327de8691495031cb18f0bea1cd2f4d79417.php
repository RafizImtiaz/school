...
<div class="home">
    <div class="flex items-center justify-between mb-6">
        ...
        <div class="flex flex-wrap items-center">
            <a href="<?php echo e(route('profile')); ?>" class="bg-gray-700 text-gray-500 text-sm uppercase py-2 px-4 flex items-center rounded">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SMS Software Project\resources\views/home.blade.php ENDPATH**/ ?>